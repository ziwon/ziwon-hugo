...
>  [Effective Go](https://golang.org/doc/effective_go.html#concurrency) 의 [한글화 문서](https://code.google.com/p/golang-korea/wiki/EffectiveGo)를 보던 중, Concurrency에 대한 부분이 빠져 있어서 해당 부분만 따로 번역해보았다. 원문의 출처는 [여기](https://golang.org/doc/effective_go.html#concurrency)다.
