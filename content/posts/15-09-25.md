...
(역자 주: 병행 프로그래밍과 병렬 프로그래밍의 차이는 아래 그림을 참조하세요. ([출처](http://joearms.github.io/2013/04/05/concurrent-and-parallel-programming.html))

{{< figure src="http://joearms.github.io/images/con_and_par.jpg" title="Concurrent and Parallel Programming" >}}
...
나머지는 [여기 한글화 문서](https://code.google.com/p/golang-korea/wiki/EffectiveGo)를 참조하길 바란다.
